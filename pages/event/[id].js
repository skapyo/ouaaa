          ...
          <Container className={styles.cardInfo}>
            ...
            <div className={styles.buttonParticipate}>
              ...
              {data && !containUser(data.event.participants)
                ...
                ) && (data.event.limitPlace === undefined || data.event.limitPlace === null || data.event.limitPlace > data.event.participants.length ) && (
                  <button
              ...
              {!(data && containUser(data.event.participants))
                && data
                && data.event.registerLink
                && data.event.registerLink.length > 1 && (data.event.limitPlace === null || data.event.limitPlace === 0 || data.event.limitPlace > data.event.participants.length ) && (
                  <a
